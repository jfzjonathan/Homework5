...
getwd()
setwd("C:\\Users\\jfzjonathan\\Desktop\\Doing Data Science\\Unit 5")
unzip("Assignment5files.zip")

## Importing the text files into a data frame and assigning it to variable df

df <- data.frame(read.delim("yob2016.txt",sep = ";", header = FALSE))
...
## Importing the text files into a data frame and assigning it to variable y2015

y2015 <- data.frame(read.delim("yob2015.txt",sep = ",", header = FALSE))
...
## https://github.com/jfzjonathan/Homework5
